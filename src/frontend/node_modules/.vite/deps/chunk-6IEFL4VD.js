...
function useStyleRegister(info, styleFn) {
  ...
  return function(node) {
    ...
    return React6.createElement(React6.Fragment, null, styleNode, node);
  };
}
...
var LocaleProvider = (props) => {
  ...
  const getMemoizedContextValue = React9.useMemo(() => Object.assign(Object.assign({}, locale4), {
    exist: true
  }), [locale4]);
...
function findDOMNode(node) {
  ...
  if (node instanceof import_react8.default.Component) {
...
var Context = React18.createContext({});
function MotionProvider(_ref) {
  var children = _ref.children, props = _objectWithoutProperties(_ref, _excluded);
  return React18.createElement(Context.Provider, {
    value: props
  }, children);
}
...
var useDomMotionEvents_default = function(callback) {
  ...
  var onInternalMotionEnd = React20.useCallback(function(event) {
...
function genCSSMotion(config) {
  ...
  var CSSMotion = React24.forwardRef(function(props, ref) {
    ...
    var setNodeRef = React24.useCallback(function(node) {
  ...
  var CSSMotionList = function(_React$Component) {
    ...
    _createClass(CSSMotionList2, [{
      ...
      value: function render() {
        ...
        var Component3 = component || React25.Fragment;
        var motionProps = {};
        ...
        return React25.createElement(Component3, restProps, keyEntities.map(function(_ref2, index) {
...
function MotionWrapper(props) {
  ...
  const needWrapMotionProviderRef = React26.useRef(false);
  needWrapMotionProviderRef.current = needWrapMotionProviderRef.current || motion === false;
  if (needWrapMotionProviderRef.current) {
    return React26.createElement(MotionProvider, {
      motion
    }, children);
  }
  return children;
...
var PropWarning = React27.memo((_ref) => {
  let {
...
var ProviderChildren = (props) => {
  ...
  let childNode = React28.createElement(React28.Fragment, null, React28.createElement(PropWarning_default, {
    dropdownMatchSelectWidth
  }), children);
  ...
  if (Object.keys(validateMessages).length > 0) {
    childNode = React28.createElement(validateMessagesContext_default.Provider, {
      value: validateMessages
    }, childNode);
  }
  if (locale4) {
    childNode = React28.createElement(locale_default, {
      locale: locale4,
      _ANT_MARK__: ANT_MARK
    }, childNode);
  }
  if (iconPrefixCls || csp) {
    childNode = React28.createElement(Context_default.Provider, {
      value: memoIconContextValue
    }, childNode);
  }
  if (componentSize) {
    childNode = React28.createElement(SizeContextProvider, {
      size: componentSize
    }, childNode);
  }
  childNode = React28.createElement(MotionWrapper, null, childNode);
  ...
  if (theme) {
    childNode = React28.createElement(DesignTokenContext.Provider, {
      value: memoTheme
    }, childNode);
  }
  if (memoedConfig.warning) {
    childNode = React28.createElement(WarningContext.Provider, {
      value: memoedConfig.warning
    }, childNode);
  }
  if (componentDisabled !== void 0) {
    childNode = React28.createElement(DisabledContextProvider, {
      disabled: componentDisabled
    }, childNode);
  }
  return React28.createElement(ConfigContext.Provider, {
    value: memoedConfig
  }, childNode);
};
var ConfigProvider = (props) => {
  ...
  return React28.createElement(ProviderChildren, Object.assign({
...
var LayoutContext = React29.createContext({
  siderHook: {
    addSider: () => null,
    removeSider: () => null
  }
...
var SiderContext = React31.createContext({});
var generateId = (() => {
  let i = 0;
  return function() {
...
var Sider = React31.forwardRef((props, ref) => {
  const {
  ...
  const renderSider = () => {
    ...
    const zeroWidthTrigger = parseFloat(String(collapsedWidth || 0)) === 0 ? React31.createElement("span", {
      onClick: toggle,
    ...
    }, trigger || React31.createElement(BarsOutlined_default, null)) : null;
    const iconObj = {
      expanded: reverseArrow ? React31.createElement(RightOutlined_default, null) : React31.createElement(LeftOutlined_default, null),
      collapsed: reverseArrow ? React31.createElement(LeftOutlined_default, null) : React31.createElement(RightOutlined_default, null)
    };
    const status = collapsed ? "collapsed" : "expanded";
    const defaultTrigger = iconObj[status];
    const triggerDom = trigger !== null ? zeroWidthTrigger || React31.createElement("div", {
    ...
    return React31.createElement("aside", Object.assign({
      className: siderCls
    }, divProps, {
      style: divStyle,
      ref
  ...
  return React31.createElement(SiderContext.Provider, {
    value: contextValue
  }, renderSider());
});
if (true) {
...
var style_default = genComponentStyleHook("Layout", (token) => [genLayoutStyle(token)], (token) => {
  const {
    colorBgLayout,
    controlHeight,
    controlHeightLG,
...
function generator(_ref) {
  ...
  return (BasicComponent) => {
    const Adapter = React32.forwardRef((props, ref) => React32.createElement(BasicComponent, Object.assign({
      ref,
      suffixCls,
      tagName
    }, props)));
...
var Basic = React32.forwardRef((props, ref) => {
  const {
    prefixCls: customizePrefixCls,
    suffixCls,
    className,
  ...
  return wrapSSR(React32.createElement(TagName, Object.assign({
    className: (0, import_classnames3.default)(customizePrefixCls || prefixWithSuffixCls, className, hashId),
    ref
  }, others)));
});
var BasicLayout = React32.forwardRef((props, ref) => {
  const {
    direction
  } = React32.useContext(ConfigContext);
  const [siders, setSiders] = React32.useState([]);
  const {
    prefixCls: customizePrefixCls,
    className,
    rootClassName,
  ...
  const [wrapSSR, hashId] = style_default(prefixCls);
  const classString = (0, import_classnames3.default)(prefixCls, {
  ...
  return wrapSSR(React32.createElement(LayoutContext.Provider, {
    value: contextValue
  }, React32.createElement(Tag, Object.assign({
    ref,
...
//# sourceMappingURL=chunk-6IEFL4VD.js.map
